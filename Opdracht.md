...
2.	Gebruik van Belgische eID certificaten
...
3.	Webbased maken met https connectie
...
4.	(Web based) vulnerability scan
...
o	Geef een omschrijving van minstens 3 vulnerabilities van Metasploitable, en hoe je die zou oplossen (patchen gaat niet goed lukken op Metasploitable OS, omdat dit echt een oefenserver is)
#Minimaal voor S&N studenten:
-	OpenVAS
o	System&Networks studenten gebruiken niet alleen Nessus voor de opdracht van hierboven, maar ook OpenVAS. Studenten kunnen dan een vergelijking maken van de 2 systemen.
-	Armitage
o	Gebruik Armitage op Windows OS van de basis opdracht (evt zonder firewall/patches), en doe een exploit van de vulnerabilities.
...
-	Metasploitable
o	Armitage gebruiken op Metasploitable OS. 
o	Geef een omschrijving van de gevaren van ten minste 5 vulnerabilities (dus 2 meer dan de basis opdracht)
...
o	Bv Windows Servers, Linux Servers, Mac OS X, mobile (Android?),…
